...
> [!NOTE]
> Частина робіт може мати проблеми з форматуванням та відповідністю Java Code Conventions, що буде виправлятись в 
> найближчих оновленнях